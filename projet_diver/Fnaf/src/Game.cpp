...
Game::Game(sf::RenderWindow &window,sf::View &camera)
{
    ...
    this->addButton(State::Idle,Button(ButtonType::Hover, sf::FloatRect(windowSize.x-100,0,100*windowRatio.x,windowSize.y) ,[&window,&camera](){Button::moveCamRight(camera,window);},true));
