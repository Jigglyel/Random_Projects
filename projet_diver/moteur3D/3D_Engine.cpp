            ...
            switch (event.type)
            {
                ...
                case sf::Event::KeyPressed:
                    ...
                    case sf::Keyboard::L:
                        ...
                        static_cast<Directional*>(globalLights[1])->couleur.r=rand()%255;
                        static_cast<Directional*>(globalLights[1])->couleur.g=rand()%255;
                        static_cast<Directional*>(globalLights[1])->couleur.b=rand()%255;

                        static_cast<Directional*>(globalLights[2])->couleur.r=rand()%255;
                        static_cast<Directional*>(globalLights[2])->couleur.g=rand()%255;
                        static_cast<Directional*>(globalLights[2])->couleur.b=rand()%255;
